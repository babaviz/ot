...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="OT\BackendBundle\Entity\TeacherRepository")
 * 
 */
class Teacher implements UserInterface, \Serializable
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="TransactionRecord", mappedBy="Teacher")
     */
    private $TransactionRecords;

    /**
     * @ORM\OneToMany(targetEntity="FreeTime", mappedBy="Teacher")
     */
    private $FreeTimes;
